      ...
      <div className="container">
        ...
        <div className="mb-20">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-semibold mb-4">Live Performance Dashboard</h3>
          ...
          <div className="bg-gradient-to-br from-chart-1 via-chart-2 to-chart-3 rounded-2xl p-8 text-white">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {sampleMetrics.map((metric, index) => {
                ...
                return (
                  <div key={JSON.stringify(metric)} className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
                    <div className="flex items-center gap-3 mb-4">
                      <div className={`size-10 rounded-lg bg-gradient-to-br ${metric.color} flex items-center justify-center`}>
