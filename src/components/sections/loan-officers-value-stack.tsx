...
const LENDING_VALUE_COMPARISON: ValueItem[] = [
  {
    title: "Mortgage Sales Training Platform",
    typical: {
      value: "$8,000",
      unit: "/mo",
      desc: "Traditional mortgage training programs and coaching",
    },
    ourPlatform: {
      value: "Included",
      desc: "Unlimited practice with realistic mortgage scenarios",
    },
  },
  {
    ...
    typical: {
      value: "$3,000",
      unit: "/setup",
      desc: "Regulatory compliance training and certification",
    },
    ourPlatform: {
      value: "Included",
      desc: "TRID, QM, and fair lending scenario training",
    },
  },
  {
    title: "Loan Officer Analytics",
    typical: {
      value: "$2,500",
      unit: "/mo",
      desc: "Performance tracking and conversion analytics",
    },
    ourPlatform: {
      value: "Included",
      desc: "Detailed metrics on objection handling and closing skills",
    },
  },
  {
  ...
  {
    title: "Mortgage CRM Integration",
    typical: {
      value: "$1,000",
      unit: "/mo",
    ...
    ourPlatform: {
      value: "Included",
      desc: "Seamless integration with major loan origination systems",
    },
  },
  {
    title: "Custom Mortgage Scenarios",
    typical: {
      value: "$5,000",
      unit: "/library",
    ...
    ourPlatform: {
      value: "Included",
      desc: "200+ mortgage scenarios across all loan types",
    },
  },
];

// Success metrics for mortgage lending
const mortgageSuccessMetrics = [
  {
    icon: TrendingUp,
    metric: "40%",
    label: "More Loan Closings",
    description: "Average increase in closed loans per loan officer after 60 days of training"
  },
  {
    icon: Shield,
    metric: "100%",
    label: "Compliance Confidence",
    description: "Loan officers demonstrate regulatory compliance in all practice scenarios"
  },
  {
    icon: Clock,
    metric: "60%",
    label: "Faster Approvals",
    description: "Reduction in loan processing time due to better upfront conversations"
  },
  {
    icon: Target,
    metric: "85%",
    label: "Rate Objection Success",
    description: "Success rate in overcoming rate objections and closing loans"
  }
];

export default function LoanOfficersValueStack() {
  const totalTypicalValue = LENDING_VALUE_COMPARISON.reduce((sum, item) => {
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              See the measurable impact on your loan officers' performance and your bottom line
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {mortgageSuccessMetrics.map((item, index) => {
        ...
        <div className="grid grid-cols-4 gap-x-4 gap-y-8 md:grid-cols-8 lg:grid-cols-12">
          ...
          <div className="col-span-4 mb-8 max-w-4xl md:col-span-8 md:mb-12 lg:col-span-10 lg:col-start-2 lg:mb-16">
            ...
            <p className="text-muted-foreground text-lg leading-snug text-center sm:text-left">
              Complete mortgage training platform with everything your loan officers need to close more deals
              and maintain compliance - all for less than traditional training costs.
            </p>
          </div>
          ...
          <div className="col-span-4 md:col-span-8 lg:col-span-10 lg:col-start-2">
            {LENDING_VALUE_COMPARISON.map((row, index) => (
              <div
                key={index}
                ...
                <div className="col-span-2 flex flex-col md:col-span-3">
                  <div className="ml-0 md:ml-32 lg:ml-40 xl:ml-48 2xl:ml-56">
                    ...
                    <p className="text-sm text-yellow-200 font-semibold mt-2">
                      Per loan officer/month - Everything included
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-white/20">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                  <div className="flex flex-col sm:flex-row gap-6">
                    ...
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-5 w-5 text-green-400" />
                      <span className="font-semibold">40% more closings guarantee</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-5 w-5 text-green-400" />
