...
export function BrandFoundationSection() {
  return (
    <div className="space-y-12">
      {/* Header */}
      <div className="space-y-4">
        <h1 className="text-4xl font-semibold tracking-tight">Brand Foundation</h1>
      ...
      {/* Color Palette */}
      <BrandFoundationColorsSection />

      <Separator />

      {/* Typography */}
      <BrandFoundationTypographySection />

      <Separator />

      {/* Logo & Branding */}
      <BrandFoundationLogoSection />

      <Separator />

      {/* Brand Voice */}
      <BrandFoundationVoiceSection />
    </div>
  )
}

function BrandFoundationColorsSection() {
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  className="gap-2"
                >
                  {showColorCodes ? <EyeOff className="size-4" /> : <Eye className="size-4" />}
                          ...
                          <div className="p-4 bg-white border rounded-xl space-y-3">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="space-y-1">
                                ...
                                <div className="h-2 w-16 bg-zinc-500 rounded" />
                              </div>
                            </div>
...
function BrandFoundationTypographySection() {
  return (
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="mt-4 p-4 bg-gradient-to-r from-background to-accent/20 rounded-lg border">
                      <h3 className="font-headline text-2xl font-semibold text-gradient mb-2">
                        SpeakStride Training
                      </h3>
                      <blockquote className="font-headline text-lg font-medium text-muted-foreground border border-primary pl-4">
...
function BrandFoundationLogoSection() {
  return (
          <section id="logo" className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-3xl font-semibold">Logo & Branding</h2>
              <p className="text-lg text-muted-foreground">
                ...
                <CardContent>
                  <div className="flex items-center justify-center h-32 bg-gradient-to-br from-background to-muted rounded-lg border">
                    <div className="font-headline text-xl font-semibold tracking-tight">
                      ...
                      <span className="font-medium text-primary">Stride</span>
                    </div>
                  </div>
                  <div className="mt-4 space-y-2">
...
function BrandFoundationVoiceSection() {
  return (
          <section id="voice" className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-3xl font-semibold">Brand Voice & Personality</h2>
              <p className="text-lg text-muted-foreground">
