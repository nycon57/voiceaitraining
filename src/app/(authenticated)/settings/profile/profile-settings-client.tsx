...
const profileMonthYearFormatter = new Intl.DateTimeFormat('en-US', {
  month: 'long',
  year: 'numeric',
})
...
type ProfileSettingsAction =
  | { type: 'field'; field: keyof ProfileData; value: string }
  | { type: 'submitting'; isSubmitting: boolean }
  | { type: 'saved' }
  | { type: 'discard'; profileData: ProfileData }
  | { type: 'notification'; field: NotificationKey; value: boolean }

function profileSettingsReducer(
  ...
  switch (action.type) {
    ...
    case 'discard':
      return { ...state, formData: action.profileData, hasChanges: false }
    case 'notification':
      return {
        ...state,
        notifications: {
...
export function ProfileSettingsClient({ user, profileData }: ProfileSettingsClientProps) {
  ...
  const [{
    ...
    isSubmitting,
    notifications,
  }, dispatch] = useReducer(profileSettingsReducer, {
    formData: initialProfileRef.current,
    hasChanges: false,
    isSubmitting: false,
    notifications: {
  ...
  const handleDiscard = () => {
    dispatch({ type: 'discard', profileData })
  ...
  const formatDate = (date: Date) => profileMonthYearFormatter.format(date)
  ...
  const sectionProps = {
    user, formData, hasChanges, isSubmitting, notifications, dispatch,
    handleInputChange, handleSave, handleDiscard, handleAvatarUpload,
    handleRemoveAvatar, getInitials, formatDate, getRoleBadgeVariant,
  }
    ...
    <>
      ...
      <div className="space-y-6 p-4 max-w-7xl mx-auto">
        <div className="flex flex-col gap-2">
          <h1 className="font-headline text-3xl font-semibold tracking-tight">Profile Settings</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <ProfileSettingsCard1 {...sectionProps} />

            {/* Avatar Upload */}
            <ProfileSettingsCard2 {...sectionProps} />

            {/* Notification Preferences */}
            <ProfileSettingsCard3 {...sectionProps} />

            {/* Security */}
            <ProfileSettingsCard4 {...sectionProps} />

            {/* Danger Zone */}
            <ProfileSettingsCard5 {...sectionProps} />
          </div>
...
type ProfileSectionProps = {
  ...
  isSubmitting: boolean
  notifications: Record<NotificationKey, boolean>
  dispatch: Dispatch<ProfileSettingsAction>
...
function ProfileSettingsCard1(props: ProfileSectionProps) {
  const { user, formData, hasChanges, isSubmitting, notifications, dispatch, handleInputChange, handleSave, handleDiscard, handleAvatarUpload, handleRemoveAvatar, getInitials, formatDate, getRoleBadgeVariant } = props
  return (
                <Card>
                  <CardHeader>
...
function ProfileSettingsCard2(props: ProfileSectionProps) {
  const { user, formData, hasChanges, isSubmitting, notifications, dispatch, handleInputChange, handleSave, handleDiscard, handleAvatarUpload, handleRemoveAvatar, getInitials, formatDate, getRoleBadgeVariant } = props
  return (
                <Card>
                  <CardHeader>
...
function ProfileSettingsCard3(props: ProfileSectionProps) {
  const { user, formData, hasChanges, isSubmitting, notifications, dispatch, handleInputChange, handleSave, handleDiscard, handleAvatarUpload, handleRemoveAvatar, getInitials, formatDate, getRoleBadgeVariant } = props
  return (
                <Card>
                  <CardHeader>
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        onCheckedChange={(value) => dispatch({ type: 'notification', field: 'emailNotifications', value })}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        onCheckedChange={(value) => dispatch({ type: 'notification', field: 'inAppNotifications', value })}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        onCheckedChange={(value) => dispatch({ type: 'notification', field: 'assignmentReminders', value })}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        onCheckedChange={(value) => dispatch({ type: 'notification', field: 'weeklyDigest', value })}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        onCheckedChange={(value) => dispatch({ type: 'notification', field: 'performanceAlerts', value })}
                      />
                    </div>
                  </CardContent>
                </Card>
...
function ProfileSettingsCard4(props: ProfileSectionProps) {
  const { user, formData, hasChanges, isSubmitting, notifications, dispatch, handleInputChange, handleSave, handleDiscard, handleAvatarUpload, handleRemoveAvatar, getInitials, formatDate, getRoleBadgeVariant } = props
  return (
                <Card>
                  <CardHeader>
...
function ProfileSettingsCard5(props: ProfileSectionProps) {
  const { user, formData, hasChanges, isSubmitting, notifications, dispatch, handleInputChange, handleSave, handleDiscard, handleAvatarUpload, handleRemoveAvatar, getInitials, formatDate, getRoleBadgeVariant } = props
  return (
