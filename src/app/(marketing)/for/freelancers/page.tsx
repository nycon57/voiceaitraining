...
export default function FreelancersPage() {
  return (
    <>
      <FreelancersHeroSectionSection />
      <FreelancersProblemSectionSection />
      <FreelancersSolutionSectionSection />
      <FreelancersROISectionSection />
      <FreelancersPricingSection />
      <FreelancersFinalCTASection />
    </>
  );
}
function FreelancersHeroSectionSection() {
  return (
...
function FreelancersProblemSectionSection() {
  return (
...
function FreelancersSolutionSectionSection() {
  return (
...
function FreelancersROISectionSection() {
  return (
    <section className="section-padding bg-muted/30">
            <div className="container">
                ...
                <Card className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent border-primary/20">
                  <CardContent className="p-8">
                    <div className="grid gap-8 md:grid-cols-2">
                      <div>
                        <h3 className="text-2xl font-semibold mb-4">Before Voice AI Training</h3>
...
function FreelancersPricingSection() {
  return (
    <section className="section-padding">
            <div className="container">
...
function FreelancersFinalCTASection() {
  return (
    <section className="section-padding bg-muted/30">
            <div className="container">
