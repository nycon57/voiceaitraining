...
export default function IndividualsPage() {
  return (
    <>
      <IndividualsHeroSectionSection />
      <IndividualsSocialProofSection />
      <IndividualsKeyBenefitsSection />
      <IndividualsHowItWorksSection />
      <IndividualsPricingCTASection />
      <IndividualsUseCasesSection />
      <IndividualsFinalCTASection />
    </>
  );
}
function IndividualsHeroSectionSection() {
  return (
    <section className="section-padding relative">
            <div className="container">
              <div className="mx-auto max-w-4xl text-center">
                ...
                <h1 className="font-headline text-5xl font-semibold tracking-tight sm:text-6xl lg:text-7xl mb-6">
...
function IndividualsSocialProofSection() {
  return (
...
function IndividualsKeyBenefitsSection() {
  return (
    <section className="section-padding">
            <div className="container">
              <div className="mx-auto max-w-2xl text-center mb-16">
                <h2 className="font-headline text-3xl font-semibold tracking-tight sm:text-4xl mb-4">
...
function IndividualsHowItWorksSection() {
  return (
    <section className="section-padding bg-muted/30">
            <div className="container">
              <div className="mx-auto max-w-2xl text-center mb-16">
              ...
              <div className="mx-auto max-w-4xl">
                <div className="space-y-8">
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h3 className="font-headline text-xl font-semibold mb-2">Choose a Scenario</h3>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h3 className="font-headline text-xl font-semibold mb-2">Practice with AI</h3>
                      <p className="text-muted-foreground">
                  ...
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h3 className="font-headline text-xl font-semibold mb-2">Get Instant Feedback</h3>
                      <p className="text-muted-foreground">
...
function IndividualsPricingCTASection() {
  return (
    <section className="section-padding">
            <div className="container">
              <div className="mx-auto max-w-4xl">
...
function IndividualsUseCasesSection() {
  return (
    <section className="section-padding bg-muted/30">
            <div className="container">
              <div className="mx-auto max-w-2xl text-center mb-16">
...
function IndividualsFinalCTASection() {
  return (
    <section className="section-padding">
            <div className="container">
