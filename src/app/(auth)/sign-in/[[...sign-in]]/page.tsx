      ...
      <SignIn
        appearance={{
          elements: {
            ...
            'cl-internal-1dauvpw': '!bg-transparent !text-foreground/60 dark:!text-foreground/70',
            'cl-internal-1k7jtru': '!bg-transparent',
            'cl-internal-gr8mll': '!bg-transparent',
            'cl-internal-y44tp9': '!bg-transparent',
            'cl-internal-1pguj3g': '!bg-transparent !text-foreground/50 dark:!text-foreground/60',
