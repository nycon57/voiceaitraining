...
test('US-040 ROI browser verification', async ({ page }) => {
  await page.goto(`${BASE_URL}/analytics/roi`, { waitUntil: 'networkidle' })

  await expect(page).toHaveURL(/\/sign-in|clerk/)
  await page.screenshot({ path: 'us040-roi-unauth-20260218-034740-24968.png', fullPage: true })
  ...
  await page.screenshot({ path: 'us040-roi-manager-login-attempt-20260218-034740-24968.png', fullPage: true })

  const postLoginUrl = page.url()
  if (postLoginUrl.includes('/sign-in/factor-one')) {
    ...
    await page.screenshot({ path: 'us040-roi-manager-factor-one-retry-20260218-034740-24968.png', fullPage: true })
  }
})
